...
exports.updateUserStatus = exports.getAgencyDetails = exports.getJobSeekers = exports.loginUser = exports.getallagencies = exports.createuser = void 0;
...
const getAgencyDetails = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ "agency": agency, "jobseeker": jobSeeker });
    }
    catch (error) {
...
const updateUserStatus = async (req, res) => {
    ...
    try {
        const user = await user_1.default.update({ status: status }, {
            where: {
                id: id
            }
        });
