...
//     try {
//       const response = await axios.get(
//         `http://localhost:4000/users/jobseekers/application-status/${agencyId}`,
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
//           },
...
//     try {
//       await axios.put(
//         `http://localhost:4000/users/jobseekers/${jobSeekerId}`,
//         { status: status },
//         {
//           headers: {
//             Authorization: `Bearer ${token}`,
  ...
  return (
    <div className="container mt-4">
      ...
      <div className="card">
        <div className="card-body">
          <h5 className="card-title">
            {agency.agency?.firstname} {agency?.agency?.lastname}
          </h5>
          <p className="card-text">
            <strong>Email:</strong> {agency.agency?.email}
          </p>
          <p className="card-text">
            <strong>Phone:</strong> {agency.agency?.phone}
          </p>
          <p className="card-text">
            <strong>Status:</strong> <span className="text-warning">{agency?.jobseeker.status}</span>
          </p>
        </div>
      </div>
      <div className="mt-4">
